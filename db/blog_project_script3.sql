CREATE DATABASE  IF NOT EXISTS `sdbm` /*!40100 DEFAULT CHARACTER SET cp1250 */;
USE `sdbm`;
...
CREATE TABLE `activity` (
  ...
  UNIQUE KEY `activitycol_UNIQUE` (`UserID`),
...
LOCK TABLES `blogitem` WRITE;
/*!40000 ALTER TABLE `blogitem` DISABLE KEYS */;
/*!40000 ALTER TABLE `blogitem` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `sdbm`.`BlogItem_AFTER_INSERT` AFTER INSERT ON `BlogItem` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `sdbm`.`BlogItem_AFTER_UPDATE` AFTER UPDATE ON `BlogItem` FOR EACH ROW
BEGIN
INSERT INTO `sdbm`.`BlogItemHsitory` 
(`ID`, `BlogItemID`, `Status`, `Action`, `X_CreateTime`)
VALUES 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `sdbm`.`BlogItem_AFTER_DELETE` AFTER DELETE ON `BlogItem` FOR EACH ROW
BEGIN
INSERT INTO `sdbm`.`BlogItemHsitory` 
(`ID`, `BlogItemID`, `Status`, `Action`, `X_CreateTime`)
VALUES 
...
--
-- Table structure for table `blogitemhsitory`
--

DROP TABLE IF EXISTS `blogitemhsitory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `blogitemhsitory` (
  `ID` varchar(36) NOT NULL,
  `BlogItemID` varchar(36) NOT NULL,
...
--
-- Dumping data for table `blogitemhsitory`
--

LOCK TABLES `blogitemhsitory` WRITE;
/*!40000 ALTER TABLE `blogitemhsitory` DISABLE KEYS */;
/*!40000 ALTER TABLE `blogitemhsitory` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `blogphoto`
--
...
--
-- Dumping data for table `blogphoto`
--

LOCK TABLES `blogphoto` WRITE;
/*!40000 ALTER TABLE `blogphoto` DISABLE KEYS */;
/*!40000 ALTER TABLE `blogphoto` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `sdbm`.`BlogPhoto_AFTER_INSERT` AFTER INSERT ON `BlogPhoto` FOR EACH ROW
BEGIN
...
--
-- Table structure for table `dicblogstatus`
--

DROP TABLE IF EXISTS `dicblogstatus`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dicblogstatus` (
  `ID` varchar(36) NOT NULL,
...
--
-- Dumping data for table `dicblogstatus`
--

LOCK TABLES `dicblogstatus` WRITE;
/*!40000 ALTER TABLE `dicblogstatus` DISABLE KEYS */;
/*!40000 ALTER TABLE `dicblogstatus` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping events for database 'sdbm'
--
...
-- Dump completed on 2016-11-11  8:19:18
